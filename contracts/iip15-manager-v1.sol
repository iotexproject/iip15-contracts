...
contract IIP15ManagerV1 is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    mapping (address => ContractInfo) internal contractRegistry;
    ...
    function approveContract(address _contractAddress) external onlyOwner {
    ...
    function disapproveContract(address _contractAddress) external onlyOwner {
        ContractInfo storage contractInfo = contractRegistry[_contractAddress];
        require(contractInfo.recipient != address(0), "Contract is not registered");
